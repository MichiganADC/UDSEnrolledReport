...
# ms_reg_file <- args[1]
ms_reg_file <- file.path("input_csv", "UMMAPMindsetRegistry_DATA_LABELS_2018-02-23_1042.csv")
...
ggplot(ms_reg, aes(x = Exam_Date)) +
  ...
  scale_x_date(name = "Visit Date", date_labels = "%b %y", date_breaks = "1 month") +
  scale_y_continuous(name = "Cumulative Participants", breaks = seq(0, nrow(ms_reg) + 10, by = 10)) + 
